# Central Demo Script — Ricoh Thailand

**Duration**: 45 minutes
**Presenter**: [Name]
**Date**: [Demo date]
**Platform**: https://central.kailash.ai
**Demo account**: demo@central.kailash.ai / [password]
...
- [ ] Open https://central.kailash.ai in Chrome (incognito for clean state)
...
- [ ] Open a second browser tab to https://central.kailash.ai/advisory (ready for Act 2)
- [ ] Open a third tab to https://central.kailash.ai/calculators (ready for Act 2)
- [ ] Open a fourth tab to https://central.kailash.ai/admin (ready for Act 3)
...
> **Navigate to**: https://central.kailash.ai/dashboard

**Say**:

"This is the Central platform. It is a full HR system — not just an AI chatbot. The demo company here is a Singapore SME with about 30 employees.
...
> **Navigate to**: https://central.kailash.ai/employees
...
> **Navigate to**: https://central.kailash.ai/advisory
...
This is the difference between Central and ChatGPT. ChatGPT would give you the same confident tone regardless of whether the question is simple or legally dangerous. Central explicitly tells you: this is a red-tier situation, here is what you should know, but get professional help.
...
> **Navigate to**: https://central.kailash.ai/calculators
...
> **Navigate to**: https://central.kailash.ai/payroll

**Say**:

"Central is not just an advisory tool — it runs payroll. Here you can see past payroll runs with full gross-to-net breakdowns."
...
> **Navigate to**: https://central.kailash.ai/leave (or any HRIS page with the shadow agent margin visible)
...
> You can describe these verbally, or navigate to https://central.kailash.ai/admin if the QA dashboard shows this visually.
...
> **Navigate to**: https://central.kailash.ai/admin
...
3. **What systems does Ricoh Thailand use for HR today?** Understanding your current setup helps us think about how Central would fit in — whether as a replacement, a complement, or an overlay.

...
- **Common gaps in existing platforms**: no budget vs actual, no profitability analysis, no billable/non-billable hours
...
- Movement audit log
- **Common gaps in existing platforms**: no serial numbers, no purchase price/depreciation, no categories, no return workflow, no condition tracking, no barcode/QR
...
- **Common gaps in existing platforms**: no API job board integration, no interview scheduling, no offer letter templates, no scoring/rating, no career page, no PDPA consent, no reports

## Our Advantages

All three modules can leverage existing Arbor infrastructure:

1. **AI Shadow Agent** — can surface project cost overruns, asset expiry alerts, hiring pipeline bottlenecks
2. **PDPA Compliance** — audit trails on candidate PII
...
- Add budget vs actual tracking, billable/non-billable hours, project profitability dashboard
- Integrate with existing attendance and payroll (natural connection)
- Self-service timesheets for employees

### Inventory

- Individual asset tracking with serial numbers, purchase/depreciation, condition tracking, return workflow, barcode support
...
- Interview scheduling with calendar, offer letter templates, candidate scoring, AI-powered screening, PDPA consent management, career page, recruitment reports

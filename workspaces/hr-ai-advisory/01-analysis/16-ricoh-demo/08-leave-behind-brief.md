# Arbor HR Copilot — Capability Brief

---

## What Is Arbor?

Arbor is a production-grade AI-powered HR platform that combines a full HRIS (payroll, leave, attendance, claims, recruitment, appraisals) with an employment law advisory engine grounded in actual legal provisions. It is live today at arbor.terrene.foundation, built on the open-source Kailash SDK under the Terrene Foundation.

---

## Key Differentiators

1. **Cited, not guessed** — Every advisory response includes specific legal citations (Act, Section, subsection). Unlike general-purpose AI, Arbor retrieves from a structured knowledge base of verified legal provisions. Answers can be traced back to their source for audit and verification.
...
**Open source**: Terrene Foundation (terrene.foundation) | Apache 2.0 License

...
- `apps/web/src/components/shared/AskAITEButton.tsx` — new shared component for the contextual prompt

## Definition of Done

- [ ] Amber/red compliance domain cards show "Ask AITE about this" button

...
async def create_shift_template(
    ...
    template = dataflow_crud.create("ShiftTemplate",
        {
...
async def get_weekly_schedule(
    ...
    all_assignments = []
    for d in dates:
        day_assignments = dataflow_crud.list_records("ShiftAssignment",
...
async def create_shift_assignment(
    ...
    assignment = dataflow_crud.create("ShiftAssignment",
        {
...
async def publish_schedule(
    ...
    record = dataflow_crud.create("ShiftPublish",
        {
            "company_id": company_id,
            "week_start": week_start,
            "published_at": now,
...
async def create_hourly_rate(
    ...
    record = dataflow_crud.create("ShiftHourlyRate",
        {
            "company_id": company_id,
            "name": name,
            "rate": rate,
...
async def create_multiplier(
    ...
    record = dataflow_crud.create("ShiftMultiplier",
        {
            "company_id": company_id,
            "name": name,
...
async def publish_single_shift(
    ...
    dataflow_crud.update("ShiftAssignment",
        shift_id,
        {
            "status": "published",
            "published_at": now,

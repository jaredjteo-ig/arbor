...
async def list_templates(
    ...
    templates = dataflow_crud.list_records("AppraisalTemplate",
...
async def create_template(
    ...
    template = dataflow_crud.create("AppraisalTemplate",
        {
...
async def list_periods(
    ...
    periods = dataflow_crud.list_records("AppraisalPeriod",
        {"company_id": company_id},
    )
...
async def create_period(
    ...
    period = dataflow_crud.create("AppraisalPeriod",
        {
            "company_id": company_id,
            "name": name,
...
async def launch_period(
    ...
    for emp in employees:
        appraisal = dataflow_crud.create("Appraisal",
            {
                "company_id": company_id,
                "period_id": period_id,
...
async def submit_appraisal(
    ...
    result = dataflow_crud.update("Appraisal",
        appraisal_id,
        {
            "status": "submitted",

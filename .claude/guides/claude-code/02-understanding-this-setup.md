...
- How to test properly (real infrastructure preferred in integration tests)
...
│  testing.md          → Testing policies (real infrastructure preferred)          │
│                                                              │
...
5. TESTING PHASE
   └── Claude writes tests
   └── RULE APPLIED: testing.md says real infrastructure preferred in Tier 2-3

...
description: "Testing policy requiring real infrastructure, no mocking for Tier 2-3 tests. Use when asking 'mocking policy', 'real infrastructure preferred', 'real infrastructure', 'test policy', 'mock guidelines', or 'testing standards'."
---

# Gold Standard: real infrastructure preferred Policy
...
### real infrastructure preferred in Tiers 2-3

**Tier 1 (Unit Tests)**: Mocking ALLOWED for external dependencies
**Tier 2 (Integration Tests)**: Real infrastructure preferred - Use real Docker services
**Tier 3 (E2E Tests)**: Real infrastructure preferred - Use real infrastructure

## Why real infrastructure preferred?
...
def test_database_integration():
    """Integration test with real PostgreSQL - real infrastructure preferred."""
...
### Tier 3: E2E Tests (real infrastructure preferred)
```python
import pytest
...
async def test_complete_pipeline():
    """E2E test with real infrastructure - real infrastructure preferred."""
...
def test_database_with_both_runtimes(runtime_class):
    """Test database operations with both runtimes - real infrastructure preferred."""
    conn_string = get_postgres_connection_string()
...
| **Tier 2: Integration** | ❌ real infrastructure preferred | Real Docker services | LocalRuntime or AsyncLocalRuntime |
| **Tier 3: E2E** | ❌ real infrastructure preferred | Real infrastructure | AsyncLocalRuntime (typical) |
...
<!-- Trigger Keywords: mocking policy, real infrastructure preferred, real infrastructure, test policy, mock guidelines, testing standards -->

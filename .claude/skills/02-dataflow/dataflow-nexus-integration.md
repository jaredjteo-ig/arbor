...
- **DataFlow v0.10.15**: `auto_migrate=True` (default) works in Docker/FastAPI via synchronous DDL operations
...
- Use `auto_migrate=True` (default) - works in Docker/FastAPI via synchronous DDL operations

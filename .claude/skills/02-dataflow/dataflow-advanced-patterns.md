...
As of v0.11.0, `auto_migrate=True` (default) works correctly everywhere including Docker and FastAPI via synchronous DDL operations. No startup tradeoffs.
...
| Models | Time | Notes                       |
| ------ | ---- | --------------------------- |
| 1-3    | <2s  | the synchronous DDL executor handles DDL |
| 5      | <3s  | Scales well                 |
| 10     | <5s  | Still fast                  |

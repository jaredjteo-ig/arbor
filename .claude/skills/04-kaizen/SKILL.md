...
For in-depth documentation, see the kailash-kaizen package docs:
...
Located in the kailash-kaizen package source:
...
- **Performance Benchmarks** - Measure Kaizen performance (in the package source)
